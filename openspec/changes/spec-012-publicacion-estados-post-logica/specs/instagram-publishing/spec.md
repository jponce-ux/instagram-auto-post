# Instagram Publishing Specification

## Purpose

Flujo completo de publicación de contenido multimedia en Instagram Graph API, gestionando estados del post y manejo de errores.
